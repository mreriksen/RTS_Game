Shader "Shader Graphs/New Shader Graph"
{
    ...
    SubShader
    {
        ...
        VertexDescription VertexDescriptionFunction(VertexDescriptionInputs IN)
        {
            ...
            float _Voronoi_e37b8339c6224618b8da9b27e9fe6674_Out_3_Float;
            float _Voronoi_e37b8339c6224618b8da9b27e9fe6674_Cells_4_Float;
            Unity_Voronoi_Deterministic_float(IN.uv2.xy, 2, 5, _Voronoi_e37b8339c6224618b8da9b27e9fe6674_Out_3_Float, _Voronoi_e37b8339c6224618b8da9b27e9fe6674_Cells_4_Float);
            float4 Color_cbffb2b1173f4e83b0ea2499ed8fbdf4 = IsGammaSpace() ? float4(0.8584906, 0.6775721, 0.3595941, 1) : float4(SRGBToLinear(float3(0.8584906, 0.6775721, 0.3595941)), 1);
            float4 _Multiply_c49339ccffb14535a5b96ebf3d73ef72_Out_2_Vector4;
            Unity_Multiply_float4_float4((_Voronoi_e37b8339c6224618b8da9b27e9fe6674_Out_3_Float.xxxx), Color_cbffb2b1173f4e83b0ea2499ed8fbdf4, _Multiply_c49339ccffb14535a5b96ebf3d73ef72_Out_2_Vector4);
            description.Position = (_Multiply_c49339ccffb14535a5b96ebf3d73ef72_Out_2_Vector4.xyz);
